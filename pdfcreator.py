        ...
        <hr style="border: 0; border-bottom: 1px solid #000; background: #000;"/>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" id="html_order_info_total" summary="Total" style="border:0">
                        ...
                        <tr>
                            ...
                            <td style="white-space:nowrap;padding-right:5px;height:20px;text-align:right;font-size:12px;font-family:arial,helvetica,sans-serif"><span class="currency">${subtotal} USD</span></td>
                        </tr>
                        <tr>
                            <td height="4" colspan="2" style="font-size:12px;font-family:arial,helvetica,sans-serif"></td>
                        </tr>
                        <tr>
                            ...
                            <td style="white-space:nowrap;padding-right:5px;height:25px;background:#cccccc none;text-align:right;font-size:12px;font-family:arial,helvetica,sans-serif"><strong><span class="currency">${total} USD</span></strong></td>
                        </tr>
                    </table>
                </td>
            </tr>
