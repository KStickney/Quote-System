...
<head>
    ...
    <script type='text/javascript' href='./js/jquery/jquery-2.0.0.min.js'></script>
    <script type='text/javascript' href='./js/jquery/jquery-ui-1.10.3.custom.min.js'></script>
    <script type='text/javascript' href='./js/jquery/jquery-migrate-1.1.1.min.js'></script>
    <script type='text/javascript' href='./js/jquery/globalize.js'></script>
    <script type='text/javascript' href='./js/actions.js'></script>
    <!--<script type='text/javascript' src='js/plugins.js'></script>-->

</head>
<body style="font-size:12px;font-family:arial,helvetica,sans-serif;background-color:#FFF;color:#000;margin:10px;padding:0">
...
<table cellspacing="0" cellpadding="0"  style="max-width:960px;background-color:#ffffff;border:0; autosize:2.4;" summary="Order details">
        <tr>
        <td style="font-size:12px; font-family:arial,helvetica,sans-serif; text-align: right;">

            <table cellspacing="0" cellpadding="0"  style="width:100%;border:0" summary="Summary">
                <tr>
                    <td style="vertical-align:top;font-size:12px;font-family:arial,helvetica,sans-serif">
                    ...
                    <td style="width:100%;padding-left:30px;font-size:12px;font-family:arial,helvetica,sans-serif">

                        <table cellspacing="0" cellpadding="2" width="100%" summary="Details" style="border:0">

                            <tr>

                                <td valign="bottom" align="left" style="font-size:12px;font-family:arial,helvetica,sans-serif">
                                    <p>                                        1106 Great Falls Ct. Unit A<br />
                                        Knightdale, NC 27545 USA<br />
                                        Tel: 1-800-479-8084<br />
                                        Kyle Stickney<br />
                                        Email: <a href="mailto:kstickney@trwsupply.com" style="border:0">kstickney@trwsupply.com<br /> <!-- CHANGE!! -->
                                ...
                                <td valign="bottom"><strong  style="font-size: 20px; text-transform: uppercase;">
                                        Quotation # <span style="text-decoration: underline;">82021-63603</span> </strong></td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            <table cellspacing="0" cellpadding="5px" style="border:0;margin-bottom:15px; float:left; width:100%;" summary="Address">
                <tr>
                    <td width="46%" align="left"><span style="font-size:14px; font-family:arial,helvetica,sans-serif;"><strong>Customer Information</strong></span></td>
                    <td width="54%" align="left"><span style="font-size:14px; font-family:arial,helvetica,sans-serif;padding-left:3px;"><strong> Quote Details</strong></span></td>
                </tr>
                <tr align="left">
                    <td width="18%" style="font-size:12px;font-family:arial,helvetica,sans-serif;"><strong>Email: </strong>
                        kimberly.elder.yp@hitachiastemo.com                    </td>
                    <td style="font-size:12px;font-family:arial,helvetica,sans-serif;padding-left: 8px;"><strong>Subject: </strong>
                        RFQ - MR-J2S-40A</td>
                </tr>
                <tr>
                    <td  align="left"></td>
                    <td><table border="0" style="width:100%;">
                            <tr>
                                <td width="174" align="left"><strong>Date:</strong></td>
                                                                <td width="333" align="left">08/20/21</td>
                            </tr>
                            <tr>
                                <td align="left"><strong>Payment  Method:</strong></td>
                                <td align="left"><span>Credit Card, Wire Transfer or Paypal</span></td>
                            </tr>
                            <tr>
                                <td width="174" align="left"><strong style="text-align: right">Delivery Method:</strong></td>
                                <td width="333" align="left"><span>Not Included</span></td>
                            </tr>
                            <!--<tr>
            ...
            <table cellspacing="0" cellpadding="3" width="100%" border="1" summary="Products" style="border:0">
                ...
                <tr align="center">
                    <th width="2%" bgcolor="#cccccc" style="font-size:13px;font-family:arial,helvetica,sans-serif">Item</th>
                    <th width="2%" bgcolor="#cccccc" style="font-size:13px;font-family:arial,helvetica,sans-serif">Qty</th>
                    <th width="13%" nowrap="nowrap" bgcolor="#cccccc" style="font-size:13px;font-family:arial,helvetica,sans-serif">Part #</th>
                    <!--<th width="25%" bgcolor="#cccccc" style="font-size:13px;font-family:arial,helvetica,sans-serif">Description</th>-->
                    <th width="8%" bgcolor="#cccccc" style="font-size:13px;font-family:arial,helvetica,sans-serif">Condition</th>
                                        <th width="5%" bgcolor="#cccccc" style="font-size:13px;font-family:arial,helvetica,sans-serif">Unit Price</th>
                    <th width="5%" bgcolor="#cccccc" style="font-size:13px;font-family:arial,helvetica,sans-serif">Line Total</th>
                    <!--<th width="5%" bgcolor="#cccccc" style="font-size:13px;font-family:arial,helvetica,sans-serif">Wt Ea.</th>-->
                    <th width="12%" bgcolor="#cccccc" style="font-size:13px;font-family:arial,helvetica,sans-serif">Stock</th>

                </tr>

                <tr align='center'><td style='text-align: center;'>2</td><td style='text-align: center;'>2</td><td style='text-align: left;'>MR-J2S-400B</td><td style='text-align: center;'>Used</td><td style='text-align: center;'>$1290</td><td style='text-align: center;'>$790</td><td style='text-align: center;'>In Stock Ships Today</td></tr>
...
<hr style="border: 0; border-bottom: 1px solid #000; background: #000;"/>
            <table cellspacing="0" cellpadding="0" width="100%" border="0" id="html_order_info_total" summary="Total" style="border:0">
                <tr>
                    <td height="4" colspan="2" style="font-size:12px;font-family:arial,helvetica,sans-serif"></td>
                </tr>
                <tr>
                    <td style="padding-right:3px;height:20px;width:100%;text-align:right;font-size:12px;font-family:arial,helvetica,sans-serif"><strong>Subtotal:</strong></td>
                    <td style="white-space:nowrap;padding-right:5px;height:20px;text-align:right;font-size:12px;font-family:arial,helvetica,sans-serif"><span class="currency">$690.00 USD</span></td>
                </tr>
                ...
                <tr>
                    <td style="padding-right:3px;height:25px;background:#cccccc none;width:100%;text-align:right;font-size:12px;font-family:arial,helvetica,sans-serif"><strong>Total:</strong></td>
                    <td style="white-space:nowrap;padding-right:5px;height:25px;background:#cccccc none;text-align:right;font-size:12px;font-family:arial,helvetica,sans-serif"><strong><span class="currency">$690.00 USD</span></strong></td>
                </tr>
        ...
        <tr>
        <td colspan="3" style="padding-top:10px;font-size:12px;font-family:arial,helvetica,sans-serif">
            <p style="font-size: 14px; font-weight: bold; text-align: center;">Quotation Conditions / Comments</p>
            <div style="border: 1px solid #cecfce; padding: 5px; font-weight: 600; line-height: 1.5;">New - 1 Year Warranty<br />
</div>
        </td>
    </tr>
...
try:
    #pdfkit.from_file('quote_template.html', 'quote.pdf',configuration=config)
    pdfkit.from_string(html,'quote.pdf',configuration=config)
